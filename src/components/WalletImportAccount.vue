        ...
        <div class="page" id="page-wallet-create-step-1">
            ...
            <div>
                <nav class="bar bar-tab bar-text-size">
                    ...
                    <router-link replace :to="link('/wallet-import-account', {animate: false})" class="tab-item external router-link-exact-active">
    ...
    export default {
        ...
        methods: {
            ...
            register () {
                ...
                import_account_by_password(this.account, this.pwd1).then((wallet) => {
                    $.hidePreloader();
                    if (wallet.imported.length) {
                        this.$router.replace({
                            path: this.link('/wallet-create-success', {
                                account: wallet.imported[0].account
                            })
                        });
                    } else {
