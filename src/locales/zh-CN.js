const locale = {
    ...
    about: {
        ...
        version: 'V1.0.1',
        desc: {
            line1: 'IDAC Wallet是一款移动端轻钱包APP，',
            line2: '通过它能实现IDAC的转账、收款和钱包管理，',
            line3: '并及时掌握IDAC的最新动态。'
        },
        disclaimer: '免责声明'
    },
    disclaimer: {
        ...
        '<p>IDAC钱包是去中心化区块链应用，在您使用之前，请充分了解区块链科技知识，具备合理使用和管理去中心化钱包的基本能力。</p>' +
        '<p>一、IDAC钱包账户和密码一旦丢失不可找回，请妥善保管好您的账户和密码，并务必备份好钱包的私钥。私钥是找回钱包的唯一凭证！因未备份私钥、未妥善保管或因操作不当而造成钱包丢失或被盗的情况，公信宝概不负责。</p>' +
        '<p>二、如果您从未经授权的第三方获取IDAC钱包APP或与本软件名称相同的应用程序，公信宝将无法保证软件的安全性，因此造成的损失由您自行承担。</p>' +
        '<p>三、使用IDAC钱包发送IDAC等功能时，您应理解区块链操作“不可撤销”属性，并自行承担因操作失误而导致结果不可逆的损失。\n</p>' +
        '<p>四、在IDAC钱包上交易时，您应当遵循有关国家政策、法律法规的要求。</p>',
        accept: '我已阅读并同意'
    },
    unlock: {
    ...
    loyalty_program: {
        ...
        tip3: '忠诚计划是公信宝推出的一项福利计划，投资者可锁定一定额度的IDAC，锁定期间金额冻结，同时享受对应的奖励。如锁定1万IDAC9个月，按年化6%，到期后可获得450个IDAC的奖励。公信宝希望投资者通过忠诚计划，享受未来公信宝发展所带来的长期效益！',
        ...
        due: '到期时间',
        amount: '锁定金额',
        available: '可用: <span class="color-danger">{amount}</span> IDAC',
        reward: '奖励: <span class="color-danger">{amount}</span> IDAC',
        join: '设置计划',
        history: '锁定记录',
        no_record: '无记录',
        locked_at: '锁定时间',
        locked_amount: '锁定金额(IDAC)',
        ...
        success: {
            title: '参与成功',
            message: '成功锁定 {amount} IDAC'
        },
        detail: {
            title: '锁定详情',
            success: {
                title: '提示',
                message: '恭喜，成功解锁 {amount} IDAC'
            }
        }
    },
    realtime_quotations: {
